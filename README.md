...
| --- | --- |
| **Apply** | 開発参加の希望 |
| **Q&A** | プロジェクトや技術構成についての質問 |
| **Workshop** | 開催告知、事前質問、当日Q&A |
| **Announcements** | フェーズの進捗報告 |

> [!TIP]
> **Pull Requestは受け付けていません。** 開発はprivateリポジトリで行っているためです。誤字脱字などの指摘はDiscussionsの **Q&A** カテゴリでお知らせください。
